...
app = Flask(__name__)
DB_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'ahpc_civil3.db')
...
def index():
    ...
    return render_template('index.html',
        total=total, anio_inicio=1888, anio_fin=1925,
...
def exportar_pdf():
    ...
    elements = [
        ...
        Paragraph("Juzgado Civil Capital 3° Nominación · Índice Onomástico de Expedientes (1888–1925)", sub),
        Spacer(1, .2*inch),
    ]
    ...
    t.setStyle(TableStyle([
        ('BACKGROUND',    (0,0), (-1,0), colors.HexColor('#0a1a2a')),
        ('TEXTCOLOR',     (0,0), (-1,0), colors.HexColor('#a0c8e8')),
        ...
        ('ROWBACKGROUNDS',(0,1), (-1,-1), [colors.white, colors.HexColor('#ecf4fd')]),
